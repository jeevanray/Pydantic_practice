            ...
            try:
                ...
                try:
                    if hasattr(mclient, "delete_file") and bucket:
                        mclient.delete_file(object_name,bucket)  # type: ignore[attr-defined]
...
if __name__ == "__main__":
    ...
    oracle_connection_config = {
        ...
        "dsn": os.environ.get("ORACLE_DSN"),  # e.g. "ora-scn21521/martechdwhprd"
    }
    oracle_connection_config = {
        "user": "uds",
        "password": "*03",
        "dsn": "ora-scn-pr:21521/martechdwhprd"
    }
    ...
    minio_connection_config = {
        ...
        "secret_key":'ERpzo3YbwUdVhLEcy2K',
    ...
    audit_config = {
        ...
        "user": "uds",
        "password": "\03",
        "dsn": "ora-scn-pr.dwhmartr.]\]techdwhprd"
    },
        "schema": "uds",
